 ...
 * @package StubManager
 * @version 1.3.0
 * @Id $Id: StubManager.php 999 2008-04-08 00:30:41Z jeanlou.dupont $
 */
//<source lang=php>
...
class StubManager
{
	...
	const thisVersion = '$Id: StubManager.php 999 2008-04-08 00:30:41Z jeanlou.dupont $';
...
#		$wgExtensionFunctions[] = __CLASS__.'::setup'; // PHP <v5.2.2 issues a warning on this one.
	...
	{	
		...
		// e.g. $Id: StubManager.php 999 2008-04-08 00:30:41Z jeanlou.dupont $
		$data = explode( ' ', $svnId );
		return $data[2];
	}
	/**
